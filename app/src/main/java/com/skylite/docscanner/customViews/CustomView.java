...
public class CustomView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.CustomViewShape);

            if (attributes.hasValue(R.styleable.CustomViewShape_clip_drawable)) {
                final int resourceId = attributes.getResourceId(R.styleable.CustomViewShape_clip_drawable, -1);
                if (-1 != resourceId) {
