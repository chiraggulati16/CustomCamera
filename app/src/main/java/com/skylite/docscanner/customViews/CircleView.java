...
public class CircleView extends CustomView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.CircleShape);
            borderWidthPx = attributes.getDimensionPixelSize(R.styleable.CircleShape_shape_borderWidth, (int) borderWidthPx);
            borderColor = attributes.getColor(R.styleable.CircleShape_shape_borderColor, borderColor);
            attributes.recycle();
        }
